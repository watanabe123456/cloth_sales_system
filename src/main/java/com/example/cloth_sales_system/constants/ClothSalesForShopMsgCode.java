...
public enum ClothSalesForShopMsgCode {
	
	SUCCESSFUL("200", "Successful"),
	ITEM_EXISTED("403", "Item existed"),
	PRODUCT_NUMBER_REQUIRED("400", "Product number cannot be null or empty or 0 less than 0 or equal 0!!"),
	...
	private ClothSalesForShopMsgCode(String code, String message) {
		this.code = code;
